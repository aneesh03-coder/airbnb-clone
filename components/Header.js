...
const Header = ({placeholder}) => {
    ...
    return (
        <header className='sticky  top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10'>
            {/* Left Section */}
            <div onClick={()=>router.push('/')} className='relative flex items-center h-9 md:h-10 cursor-pointer my-auto'>
                <Image 
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-md mr-2'>
                <input type="text" className='flex-grow text-sm text-gray-600 placeholder-gray-400 pl-5 bg-transparent outline-none overflow-scroll scrollbar-hide' placeholder={placeholder ||'Start your Search'} value={searchInput} onChange={e => setSearchInput(e.target.value)}/>
